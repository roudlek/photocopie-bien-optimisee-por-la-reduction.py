while True :
  ...
  if Nbp <= 10 and Nbp > 0 :
      ...
      Facture = 5 + 2.7 + 0.5 * (Nbp - 19) * 0.4    # meme chose pour nombres ajoute 5 dh + reduction de 30 % de 11 iemes pages a la 19 pages + les autres page debutant par 20 jusqua +linfinie
      print("La facture est",Facture)
  else:
      print(f"Le nombre saisis {Nbp} est incorrect !!")
